export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">Privacy Policy for ShadyBOT</h1>
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <p>⊳ You have to vote for the <a className="text-white" href="https://top.gg/bot/1111055828586344458/vote">ShadyBOT</a> bot when using certain commands from the bot commands.</p>
        <div className="py-3"></div>
