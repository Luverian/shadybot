...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/bot/1111055828586344458/vote">ShadyBOT</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
